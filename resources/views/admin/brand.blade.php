<div>
    ...
    <x-modal.card title="Brand" blur wire:model.defer="modalIsActive" x-on:close="resetModal">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">     
            <div class="col-span-1 sm:col-span-2">
                <x-input label="Brand Name" wire:model.defer="brand.name"  placeholder="Enter brand name" />
            </div>
        </div>
