    ...
    <x-modal.card title="{{ $title }}" blur wire:model.defer="modalIsActive" x-on:close="resetModal">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">     
            <div class="col-span-1 sm:col-span-2">
                <x-input label="Item Serial Number" wire:model.defer="item.serial_number"  placeholder="Enter serial number" />
            </div>
            <x-select
                label="Select Brand"
                wire:model.defer="item.brand_id"
                :options="$brand"
