<div>
    ...
    <x-modal.card title="Type" blur wire:model.defer="modalIsActive" x-on:close="resetModal">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">     
            <div class="col-span-1 sm:col-span-2">
                <x-input label="Type Name" wire:model.defer="type.name"  placeholder="Enter type name" />
            </div>
        </div>
    ...
    <x-modal.card title="Delete type" blur wire:model.defer="modalDeleteIsActive">
        <div class="">     
            <div>
