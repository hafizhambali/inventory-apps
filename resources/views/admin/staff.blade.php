<div>
    ...
    {{-- <nav class="flex mb-4" aria-label="Breadcrumb">
      ...
      <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Employee</h2>
      <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">You can create, edit and delete employee detail here.</p>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4 mt-4">
        <div class="flex justify-between">
            ...
            <div class="flex">
                <x-button wire:click="departmentModalClicked" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4">
                ...
                <x-button wire:click="employeeModalClicked" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4">
                    <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4.243a1 1 0 1 0-2 0V11H7.757a1 1 0 1 0 0 2H11v3.243a1 1 0 1 0 2 0V13h3.243a1 1 0 1 0 0-2H13V7.757Z" clip-rule="evenodd"/>
                      </svg>
    ...
    <x-modal.card title="Employee" blur wire:model.defer="employeeModal">
    ...
    <x-modal.card title="Department" blur wire:model.defer="departmentModal">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">     
            <div class="col-span-1 sm:col-span-2">
                <x-input label="Department Name" placeholder="Enter department name" />
            </div>
            <div class="col-span-1 sm:col-span-2">
                <x-input label="Code" placeholder="Example: TC, TD" />
            </div>
        </div>
